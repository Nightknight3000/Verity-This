...
QUESTION_PROMPTS = {
    "en": {
        ...
        "init": "Enter call",
        "self_pos": "Your current position",
        "self_pos_optional_suffix": " [optional]",
        "number_of_doubles": "Total number of doubles inside",
        "call_outside": "Outside statue {field}",
        "call_inside": "Inside wall {field}",
        "field": {"l": "left", "m": "middle", "r": "right"},
        "restart": "Restart (y/N)?",
    },
    "de": {
        "mode": "Modus eingeben",
        "n_strat": "Nutzt dein Team die 'Double-Up'- oder die 'Speed'-Strategie?",
        "init": "Call eingeben",
        "self_pos": "Deine momentane Position",
        "self_pos_optional_suffix": " [optional]",
        "number_of_doubles": "Gesamtzahl der Doppel innen",
        "call_outside": "Äußere Statue {field}",
        "call_inside": "Innere Wand {field}",
